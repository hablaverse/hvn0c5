...
GITHUB_REPO = "hablaverse/hvn0c5"
GITHUB_RAW = f"https://raw.githubusercontent.com/{GITHUB_REPO}/main/habla_short.mp4"


def host_video_on_github(video_path_obj):
    """
    Commit the video into the repo at habla_short.mp4 and return its
